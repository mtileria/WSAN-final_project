...
////////////Complete Topology
////int n = 5;  
//String neighbors [2] = {"C2", "3E","34","3C","CC"};

////Line Topology
////int n = 1;
//String neighbors [1] = {"3E"};

/////Circle Topology
////int n = 2;
//String neighbors [2] = {"3E","34"}; // circle topology

/////Grid Topology
int n = 2;
String neighbors [2] = {"3E",""}; // grid topology
...
void change_state(int data){
  Serial.println("update my status" + String(data));
  for (int i = 0; i < 3; i++){
    if (data != i){
