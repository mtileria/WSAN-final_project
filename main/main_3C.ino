...
String My_ID = "3C";
//int const n = 5;           // complete topology 
//String neighbors [n] = {"C2", "3E","3D","34","CC"};// for complete graph
//int const n = 2; // line topology 
//String neighbors[n]={"C2","34"}; // for line topology

int const n = 2; // grid topology 
String neighbors[n]={"CC","34"}; 
...
void change_state(int data){
  Serial.println("update my state: " + String(data));
  for (int i = 0; i < 3; i++){
    if (data != i){
