...
//////////////////COMPLETE
//int const n = 2;           // number of neighbours
//String neighbors [5] = {"CC", "34", "3D", "3C", "3E"};
...
//////////////////GRID
int const n = 3;             // number of neighbours
String neighbors [n] = {"3E", "CC", "34"};
...
if (count == next) { 
  if (active_mode == false){
      ...
      Serial.println("n==c, but m already active");
    }
  }
