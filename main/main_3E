...
String My_ID = "3E";
/////Complete Topology
//int const n = 5;           // number of nodes
//String neighbors [n] = {"CC", "3D","C2","34","3C"};  // complete topology
////////Line Topology
//int const n = 2; 
//String neighbors [n] = {"CC", "3D"};    // line topology
//// Grid Topology
int const n = 2; 
String neighbors [n] = {"C2", "3D"};  // grid topology
...
void change_state(int data){
  Serial.println("updating status to: " + String(data));
  for (int i = 0; i < 3; i++){
    if (data != i){
