...
boolean SIR = false;   /// SIR FLAG
int counter = 0;
boolean start_timer = false;

//Node CC (COM17)
//String My_ID = "CC";
//String neighbors [2] = {"3C", "34"};

////Node 3C (COM116) Line Topoplogy
String My_ID = "3C";
String neighbors [1] = {"3A"};  // Line Topology
//String neighbors [2] = {"3A","23"}; // Circle Topology
//String neighbors [6] = {"3A","23","C2","CC","3D","3E"}; // Complete Topology
//String neighbors [2] = {"3A","CC"}; // Grid Topology

int n = 1;           // number of nodes for Line Topology
//int n = 2;           // number of nodes for Circle and Grid Topology
//int n = 6;             // number of nodes for Complete Topology


////Node 34 (COM10)
//String My_ID = "34";
//String neighbors [2] = {"CC", "3C"};
