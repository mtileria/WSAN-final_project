...
////LINE
const int n = 1;           // number of neighbour
String neighbors [n] = {"3E"};

////CIRCLE
//const int n = 2;           // number of neighbour
//String neighbors [n] = {"3C", "3E"};

//COMPLETE
//const int n = 6;           // number of neighbour
//String neighbors [n] = {"3C", "3A", "C2", "CC", "3D", "3E"};

////GRID
//const int n = 1;           // number of neighbour
//String neighbors [n] = {"3D"};
