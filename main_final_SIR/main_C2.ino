...
String neighbors [2] = {"CC","3A"}; // Line and Circle   Topology
//String neighbors [6] = {"3A","23","3C","CC","3D","3E"}; // Complete Topology
//String neighbors [3] = {"3A","CC","3E"}; // Grid Topology

int n = 2;           // number of nodes for Circle and Line Topology
//int n = 3;           // number of nodes for Grid Topology
